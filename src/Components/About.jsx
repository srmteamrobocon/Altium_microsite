        ...
        <section className=" text-white py-16" id="about">
            <div className="container mx-auto text-center text-white">
                ...
                <div className="flex justify-center items-center mb-5">
                    <div className="card text-gray-200 w-[clamp(260px,80%,300px)] hover:brightness-90 transition-all cursor-pointer group bg-gradient-to-tl from-gray-900 to-gray-950 hover:from-gray-800 hover:to-gray-950 border-r-2 border-t-2 border-gray-900 m-4 rounded-lg overflow-hidden relative">
                        <div className="px-8 py-10">
                            ...
                            <div className="text-gray-200 uppercase tracking-widest">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pl-2 pr-2">
                    <div className="md:text-left">
                        <h3 className="text-2xl font-Orbitron font-semibold mb-4 underline">Why Altium Designer ?</h3>
                    ...
                    <div className="md:text-left ">
                        <h3 className="text-2xl font-Orbitron font-semibold mb-4 underline">What You Will Learn</h3>
                ...
                {/* Speaker Section */}
                <h2 className="text-3xl font-Orbitron font-semibold mb-1 mt-3 p-4">Meet Our Speaker</h2>
